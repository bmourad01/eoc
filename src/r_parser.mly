...
%token <float> FLOAT
%token <string> VAR
%token PLUS MINUS STAR FSLASH SQRT INT2FLOAT FLOAT2INT REM LAND LOR LXOR LNOT 
...
prim:
  ...
  | LPAREN MINUS exp RPAREN
    { Minus $3 }
  | LPAREN SQRT exp RPAREN
    { Sqrt $3 }
  | LPAREN INT2FLOAT exp RPAREN
    { Int2float $3 }
  | LPAREN FLOAT2INT exp RPAREN
    { Float2int $3 }
